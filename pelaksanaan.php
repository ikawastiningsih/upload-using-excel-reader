...
<div class="card mb-3">
	<div class="card-header">
  		<i class="fa fa-table"> Pelaksanaan Program Kerja </i> 
	</div>
</div>
...
<table class="table table-bordered" id="" width="100%" cellspacing="0">
  ...
  <tfoot>
    <?php
      ...
      $query = mysqli_query($konek, "SELECT kategori, program_kerja, keterangan, id_proker, rfi FROM proker WHERE po = 'v' AND selesai != 'v'")or die(mysqli_error());
